...
var welcomeMessage = "Good Morning everyone, judges, and special guest Russell Okung. GO BRONCOS, GO BRONCOS, GO. and all raiders fans please leave the building";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Are you still there?";

// this is the message that is repeated if Alexa does not hear/understand the reponse to the welcome message
var promptToStartMessage = "Sorry, I could not understand you";

// This is the prompt during the game when Alexa doesnt hear or understand a yes / no reply
var promptToSayYesNo = "Sorry, I could not understand you";

// This is the response to the user after the final question when Alex decides on what group choice the user should be given
var decisionMessage = "";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
var playAgainMessage = "Thank you everybody and go Broncos... P.S. Russell can you also tell Trevor to throw deep balls to Demaryius more often. I need them points for fantasy. Thanks homie.";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will have a conversation with you about the best team in the NFL... the Denver Broncos";
